...
6. 다운로드한 파일을 아래 경로에 저장:
   ```
   /Users/inkeun/work/vault-worv/.creds/gmail_oauth_credentials.json
   ```

### 2. 첫 실행 시 인증

```bash
source /Users/inkeun/work/vault-worv/.venv/bin/activate && \
  python /Users/inkeun/work/vault-worv/.claude/skills/gmail-reader/scripts/gmail_client.py
```
...
# Gmail 검색 쿼리로 검색
source /Users/inkeun/work/vault-worv/.venv/bin/activate && \
  python /Users/inkeun/work/vault-worv/.claude/skills/gmail-reader/scripts/search_emails.py \
...
# 읽지 않은 메일 확인
source /Users/inkeun/work/vault-worv/.venv/bin/activate && \
  python /Users/inkeun/work/vault-worv/.claude/skills/gmail-reader/scripts/get_email.py \
    --unread --max 10
...
```bash
rm /Users/inkeun/work/vault-worv/.creds/gmail_token.pickle
